...
## Installation
To run the game, you'll need Python and Pygame installed on your system. If you don't have them installed, you can get Python from python.org and install Pygame by running pip install pygame in your command line.
